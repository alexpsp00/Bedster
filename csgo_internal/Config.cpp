...
void CConfig::Setup()
{
	...
	SetupValue(Vars.Legitbot.Aimbot.WeaponGroupConfig, false, strenc("Legitbot"), strenc("WeaponGroupConfiguration"));
	SetupValue( Vars.Legitbot.Aimbot.Hitbox, 6, strenc( "Legitbot" ), strenc( "Hitbox" ) );
	SetupValue(Vars.Legitbot.Aimbot.pistol_hitbox, 6, strenc("Legitbot"), strenc("PistolHitbox"));
